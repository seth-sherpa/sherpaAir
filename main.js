...
function goToFlightSearchPage() {
    ...
    // Checks if return date is disabled on flight search and sets it to null if it is. 
    // Otherwise returnDate is set to the date selected
...
function getItinerary(booking_number) {
...
//builds the trip element based on the query parameters
function buildElement() {
    ...
    const elementConfig = {
        ...
        segments: [{
            ...
            origin: {
                airportCode: segments[0].originCode,
            },
            destination: {
                airportCode: segments[0].destinationCode,
            },
            travelMode: 'AIR',
            departureDate: segments[0].departureDate,
            arrivalDate: segments[0].arrivalDate,
        }, ],
    };
    ...
    const elementConfig = {
        ...
        segments: [{
          ...
          },
          {
            segmentType: 'RETURN',
            origin: {
              airportCode: segments[1].originCode,
            },
            destination: {
              airportCode: segments[1].destinationCode,
            },
            departureDate: segments[1].departureDate,
            arrivalDate: segments[1].arrivalDate,
          },
        ],
      }
